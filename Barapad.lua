...
function Login()
	...
	-- Информация слева
		...
		Bar.MidL(WIGHT,12, "Хотите получить доступ?")
		Bar.MidL(WIGHT,13, "Отпишите в личку ВК")
		Bar.MidL(WIGHT,14, "https://vk.cc/8OUJv2")
		Bar.MidL(WIGHT,18, "&aДоступные команды:")
		Bar.MidL(WIGHT,20, "Перезапуск компа -")
		Bar.MidL(WIGHT,21, "      &d1104000")
		Bar.MidL(WIGHT,23, "Запуск обновлялки -")
